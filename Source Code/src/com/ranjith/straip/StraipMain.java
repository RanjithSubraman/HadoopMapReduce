...
public class StraipMain extends Configured implements Tool {
	...
	public static void main(String args[]) throws Exception {
		int exitCode = ToolRunner.run(new StraipMain(), args);
